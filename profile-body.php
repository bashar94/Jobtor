						...
						<div class="panel  panel-default">
							<div class="panel-body panel-shadow">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<a class="about-page" href="/<?php echo $a['username'];?>"><strong><?php if($profile['doctor']){ echo $profile['fullname']; }else{ echo $profile['college']; }; ?></strong></a>
				...
				<nav aria-label="Page navigation">
					<ul class="pagination">
						...
						<?php if($pn > 1){ ?>
							...
							<li>
								<a href="/<?php echo $pageid; ?>/subs/<?php echo $pn-1; ?>" aria-label="Previous">
						...
						while($i <= $j){ ?>
							 ...
							 <li class="<?php if($pn == $i) echo 'active';?>"><a href="/<?php echo $pageid; ?>/subs/<?php echo $i ?>"><?php echo $i; ?></a></li>

						<?php $i++;  } if($pn < $numPage){ ?>
						<li>
							<a href="/<?php echo $pageid; ?>/subs/<?php echo $pn+1; ?>" aria-label="Next">
...
<?php
	...
	if($num_rows == 0){ ?>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
				<div class="alert alert-danger text-center">
					<strong>No Ads has been posted!</strong>
				</div>
			</div>
		</div>
				...
				<nav aria-label="Page navigation">
					<ul class="pagination">
						...
						while($i <= $j){ ?>
							 ...
							 <li class="<?php if($pn == $i) echo 'active';?>"><a href="/<?php echo $pageid; ?>/ad/<?php echo $i ?>"><?php echo $i; ?></a></li>
	          ...
	          while($a = mysqli_fetch_assoc($r)){ ?>
	            <div class="panel panel-default">
	              <div class="panel-body panel-shadow">
	                	...
	                	<a class="about-page" href="/<?php echo $a['username'];?>"><strong><?php echo $profile['fullname']; ?></strong></a>
	            ...
	            <nav aria-label="Page navigation">
	              <ul class="pagination">
	                ...
	                <?php if($pn > 1){ ?>
	                  ...
	                  <li>
	                    <a href="/<?php echo $pageid; ?>/jobs/<?php echo $pn-1; ?>" aria-label="Previous">
	                      <span aria-hidden="true">&laquo;</span>
	                    </a>
	                  </li>
	                ...
	                while($i <= $j){ ?>
	                   ...
	                   <li class="<?php if($pn == $i) echo 'active';?>"><a href="/<?php echo $pageid; ?>/jobs/<?php echo $i ?>"><?php echo $i; ?></a></li>

	                <?php $i++;  } if($pn < $numPage){ ?>
	                <li>
	                  <a href="/<?php echo $pageid; ?>/jobs/<?php echo $pn+1; ?>" aria-label="Next">
	                    <span aria-hidden="true">&raquo;</span>
	                  </a>
	                </li>
	                <?php } ?>
