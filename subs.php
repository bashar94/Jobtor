  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
      <div class="panel panel-border panel-shadow">
        <div class="panel-heading panel-black text-center"><strong>Substitute Search</strong></div>
          <div class="panel-body">
            ...
            <form action="submit.php" autocomplete="off" method="POST">
              ...
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <input type="number" class="form-control" name="duration" placeholder="Put number of days/months" required>
              </div>
  ...
  <!-- Place starts-->
    ...
    <!-- Place ends-->
            ...
            <?php } ?>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <input type="text" class="form-control" name="payment" placeholder="In Taka" required>
              </div>
              ...
              <?php if($user['doctor']){ ?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <input type="text" class="form-control" name="hospital" placeholder="Name of The Hospital" required>
                </div>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <textarea type="text" class="form-control" rows="3" name="details" placeholder="Write about the job in details" required></textarea>
              </div>
